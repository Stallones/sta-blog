    ...
    return {
        plugins: [
            ...
            vue({
                template: {
                compilerOptions: {
                    // 告诉Vue：toggle-button是原生自定义元素
                    isCustomElement: (tag) => tag === 'toggle-button'
                }
                }
            }),
        ...
        css: {
            preprocessorOptions: {
                scss: {
                    ...
                    additionalData: `@use "src/styles/variable" as *; @use "src/styles/glass" as *; @use "src/styles/_layout" as *;`,
