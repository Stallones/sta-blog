...
.offline-search {
  ...
  .search-input-wrap {
    ...
    padding: 0 16px;
    border-radius: 45px;
    background: var(--secondary-bg, #1a1a2e); // 深色背景匹配截图
    ...
    &.expanded {
      width: 100%;
      border-radius: 8px; // 展开后与公告圆角一致

      &:hover {
        transform: none; // 展开后不需要 hover 放大
      }
    ...
    &.expanded.focused {
      ...
      box-shadow: 0 0 0 2px rgba(64, 158, 255, 0.15), 0 4px 20px rgba(0, 0, 0, 0.3);
    }
  }
}
