...
.tag-list-container {
    ...
    .tag-item {
      ...
      box-shadow: 0 3px 6px hsla(0, 0%, 0%, 0.04);
      ...
      // 为每个标签添加不同的阴影方向
      &:nth-child(odd) {
        box-shadow: 1px 2px 5px hsla(0, 0%, 0%, 0.03);
      }
      ...
      &:hover {
        ...
        box-shadow: 0 4px 10px hsla(0, 0%, 0%, 0.07),
          0 0 6px rgba(255, 182, 193, 0.2);
        background: linear-gradient(
          135deg,
      ...
      .tag-content {
        ...
        .tag-count {
          ...
          font-weight: 500;
          min-width: 16px;
          box-shadow: 0 1px 2px hsla(0, 0%, 0%, 0.03) inset;
          transition: all 0.3s ease;
        }
      }
